...
public abstract class BaseRules implements Rules {
    ...
    /**
     * @author Silver 
     * @date 2016年8月16日 上午9:28:32
     */
    public boolean generateLockByPrimaryKey() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isLockByPrimaryKeyStatementEnabled()
                && introspectedTable.hasPrimaryKeyColumns()
                && (introspectedTable.hasBaseColumns() || introspectedTable
                        .hasBLOBColumns());
     ...
     * @date 2016年8月16日 上午9:28:32
     */
    public boolean generateLockByExample() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isLockByExampleStatementEnabled()
                && (introspectedTable.hasBaseColumns() || introspectedTable
                        .hasBLOBColumns());
     ...
     * @date 2016年8月16日 上午9:28:32
     */
    public boolean generatePageByExample() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isPageByExampleStatementEnabled()
                && (introspectedTable.hasBaseColumns() || introspectedTable
                        .hasBLOBColumns());
     ...
     * @date 2016年8月16日 上午9:28:32
     */
    public boolean generateLastInsertId() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isLastInsertIdStatementEnabled()
                && introspectedTable.hasPrimaryKeyColumns()
                && (introspectedTable.hasBaseColumns() || introspectedTable
                        .hasBLOBColumns());
