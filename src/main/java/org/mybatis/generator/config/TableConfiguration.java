...
public class TableConfiguration extends PropertyHolder {
    ...
    /** Silver The select for update by primary key statement enabled. */
    private boolean lockByPrimaryKeyStatementEnabled;
    
    /** Silver The select for update by primary key statement enabled. */
    private boolean lockByExampleStatementEnabled;
    
    /** Silver The select for update by primary key statement enabled. */
    private boolean pageByExampleStatementEnabled;

    /** Silver The select for update by primary key statement enabled. */
    private boolean lastInsertIdStatementEnabled;
    ...
    public TableConfiguration(Context context) {
         ...
         * Silver
         */
        lockByPrimaryKeyStatementEnabled = true;
        /**
         * Silver
         */
        lockByExampleStatementEnabled = true;
        /**
         * Silver
         */
        pageByExampleStatementEnabled = true;
        /**
         * Silver
         */
        lastInsertIdStatementEnabled = true;
    ...
    /**
     * @author Silver 
     * @date 2016年8月16日 上午9:28:56
     */
    public boolean isLockByPrimaryKeyStatementEnabled() {
        return lockByPrimaryKeyStatementEnabled;
    }
     ...
     * @date 2016年8月16日 上午9:28:56
     */
    public boolean isLockByExampleStatementEnabled() {
        return lockByExampleStatementEnabled;
    }
    /**
     * @author Silver 
     * @date 2016年8月16日 上午9:28:56
     */
    public boolean isPageByExampleStatementEnabled() {
        return pageByExampleStatementEnabled;
    }
     ...
     * @date 2016年8月16日 上午9:28:56
     */
    public boolean isLastInsertIdStatementEnabled() {
        return lastInsertIdStatementEnabled;
    }
