...
public abstract class IntrospectedTable {
 ...
 MYBATIS3
    ...
    protected enum InternalAttribute {
        ...
        /** Silver The attr lock by primary key statement id. */
        ATTR_LOCK_BY_PRIMARY_KEY_STATEMENT_ID,
        
        /** Silver The attr lock by example statement id. */
        ATTR_LOCK_BY_EXAMPLE_STATEMENT_ID,

        /** Silver The attr page by example statement id. */
        ATTR_PAGE_BY_EXAMPLE_STATEMENT_ID,
        /** Silver The attr last insert id statement id. */
        ATTR_LAST_INSERT_ID_STATEMENT_ID,
    ...
    protected void calculateXmlAttributes() {
        ...
        // Silver
        setLockByPrimaryKeyStatementId("lockByPrimaryKey"); //$NON-NLS-1$
        // Silver
        setLockByExampleStatementId("lockByExample"); //$NON-NLS-1$
        
        // Silver
        setPageByExampleStatementId("pageByExample"); //$NON-NLS-1$
        // Silver
        setLastInsertIdStatementId("lastInsertId"); //$NON-NLS-1$
     ...
     * @param s
     */
    public void setLockByPrimaryKeyStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_LOCK_BY_PRIMARY_KEY_STATEMENT_ID, s);
    }
     ...
     * @param s
     */
    public void setLockByExampleStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_LOCK_BY_EXAMPLE_STATEMENT_ID, s);
    }
    
    /**
     * Sets the page by primary  statement id.
     * Silver
     * @param s
     */
    public void setPageByExampleStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_PAGE_BY_EXAMPLE_STATEMENT_ID, s);
    }
     ...
     * @param s
     */
    public void setLastInsertIdStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_LAST_INSERT_ID_STATEMENT_ID, s);
    }
    ...
    /**
     * @author Silver 
     * @date 2016年8月16日 上午10:17:23
     */
    public String getLockByPrimaryKeyStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_LOCK_BY_PRIMARY_KEY_STATEMENT_ID);
    }
     ...
     * @date 2016年8月16日 上午10:17:23
     */
    public String getLockByExampleStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_LOCK_BY_EXAMPLE_STATEMENT_ID);
    }
    /**
     * @author Silver 
     * @date 2016年8月16日 上午10:17:23
     */
    public String getPageByExampleStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_PAGE_BY_EXAMPLE_STATEMENT_ID);
    }
    /**
     * @author Silver 
     * @date 2016年8月16日 上午10:17:23
     */
    public String getLastInsertIdStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_LAST_INSERT_ID_STATEMENT_ID);
    }
